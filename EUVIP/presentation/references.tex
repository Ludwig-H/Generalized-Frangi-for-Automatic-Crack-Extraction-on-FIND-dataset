...
\DeclareShort{gretsi25}
 {L.~Hauseux et al., ``Généralisation du filtre de Frangi pour l'extraction des réseaux de fissures.'' GRETSI,~2025.}
\DeclareShort{euvip26}
 {L.~Hauseux et al., ``Multi-Modal, Training-Free Crack Extraction via Generalized Frangi Graph.'' EUVIP,~2026.}
\DeclareShort{find22}
 {S.~Zhou, C.~Canchila, W.~Song. ``Fused Image dataset for crack Detection (FIND).'' Zenodo,~2022.}
\DeclareShort{cracksegdiff24}
 {X.~Jiang et al., ``CrackSegDiff: Diffusion Probability Model-based Multi-modal Crack Segmentation.'' 2024.}
\DeclareShort{ans26}

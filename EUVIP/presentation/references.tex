...
\DeclareRef{find22}{FIND 22}
 ...
 {``Fused Image dataset for convolutional neural Network-based crack Detection (FIND).'' Zenodo,~2022. \href{https://zenodo.org/records/6383044}{zenodo.org/records/6383044}.}
\DeclareRef{cracksegdiff24}{CrackSegDiff 24}
 {X.~Jiang, L.~Jiang, A.~Wang, K.~Zhu, Y.~Gao.}
 {``CrackSegDiff: Diffusion Probability Model-based Multi-modal Crack Segmentation.'' arXiv, 2024. \href{https://arxiv.org/abs/2410.08100}{arXiv:2410.08100}.}
...
\DeclareRef{sam23}{SAM 23}
 {A.~Kirillov et al.}
 {``Segment Anything.'' ICCV, pp.~4015--4026, 2023. \href{https://arxiv.org/abs/2304.02643}{arXiv:2304.02643}.}
\DeclareRef{cracksam24}{CrackSAM 24}
 {K.~Ge, C.~Wang, Y.~Guo, Y.~Tang, Z.~Hu, H.~Chen.}
 {``Fine-tuning vision foundation model for crack segmentation in civil infrastructures.'' Construction and Building Materials, 431, 136573, 2024. \href{https://doi.org/10.1016/j.conbuildmat.2024.136573}{doi.org/10.1016/j.conbuildmat.2024.136573}.}
...
\DeclareShort{ans26}
 {L.~Hauseux et al., ``Generalization of Single-Linkage with higher-order interactions.'' Appl.~Netw.~Sci.,~2026.}
\DeclareShort{sam23}

...
\newcommand{\refnote}[1]{\begin{textblock*}{.88\paperwidth}(.06\paperwidth,.905\paperheight)
 {\fontsize{5.5}{6.0}\selectfont\color{gris_fonce_inria}#1\par}\end{textblock*}}
...
\newcommand{\bibentry}[3]{\par\vspace{2.3mm}
 \begin{minipage}[t]{.23\linewidth}\footnotesize\textcolor{inria-2024-bleu-canard}{\textbf{[#1]}}\end{minipage}\hfill
 \begin{minipage}[t]{.75\linewidth}\raggedright\footnotesize #2\par{\scriptsize #3}\end{minipage}\par}
\makeatletter
...
\begin{columns}[T,onlytextwidth]
 ...
 \begin{column}{.40\textwidth}
  \begin{itemize}\setlength\itemsep{5mm}
   ...
   \item Goal: extract an \textbf{editable crack skeleton} \textbf{without training}.
  \end{itemize}
 \end{column}
\end{columns}
\vspace{2mm}
{\small FIND dataset, aligned intensity and range views.}
\refnote{[FIND 22; EUVIP 26]}
\end{frame}
...
\begin{itemize}\setlength\itemsep{3.5mm}
 ...
 \item \textbf{Direction}: $e_1$ follows the ridge
\end{itemize}
\vspace{2mm}
\[
...
\]
\vspace{-1mm}
{\small For $\lambda_2>0$; otherwise $F_\sigma=0$.}
\end{column}
\end{columns}
\refnote{[Frangi 98]}
\end{frame}
...
\begin{tikzpicture}[x=1cm,y=1cm,
 ...
 \node[font=\footnotesize,align=center]at(1.3,1.05){aligned axes\\strong edge};
 \begin{scope}[shift={(4.35,0)}]
  ...
  \node[font=\footnotesize,align=center]at(1.2,1.05){misaligned axes\\weak edge};
 \end{scope}
\end{tikzpicture}}
\end{column}
\begin{column}{.40\textwidth}
\begin{itemize}\setlength\itemsep{4mm}
 ...
 \item Alignment refines intensity and shape information.
\end{itemize}
\vspace{2mm}
\[
...
\panel{.21}{Resultat_1FIND.png}{Skeleton}
\par\vspace{3mm}
...
\]
\refnote{$\rho_{ij}=\|x_i-x_j\|_2\leq R$. [EUVIP 26]}
\end{frame}
...
\begin{column}{.41\textwidth}
 ...
 \panel{.475}{Resultat_1FIND.png}{Our result}
\end{column}
\begin{column}{.55\textwidth}
{\small\textbf{Intensity + range}}
\vspace{2mm}
...
{\small $F$: filtered range.}
\end{column}
\end{columns}
\refnote{Overlap: skeletons dilated by 3 px; Tversky $(\alpha,\beta)=(1,0.5)$; $W$: Wasserstein. [FIND 22; EUVIP 26; CrackSegDiff 24]}
\end{frame}
...
\begin{column}{.57\textwidth}\centering
 ...
 {\small \textcolor{red}{\rule[.4ex]{7mm}{.7pt}} Our graph\qquad
...
\]
{\small $N,N'\sim\mathcal N(0,s^2)$, independent.}
\vspace{2mm}
...
\begin{itemize}\setlength\itemsep{2mm}
 \item Lower initial accuracy
 \item Slower degradation in this test
\end{itemize}
\end{column}
\end{columns}
\refnote{Bands: standard deviation. [EUVIP 26; CrackSegDiff 24]}
\end{frame}
...
\begin{column}{.48\textwidth}
 ...
 \panel{.475}{Test1_512_512_result.png}{Test 1}\hfill
 \panel{.475}{Test2_512_512_result.png}{Test 2}
 \vspace{2mm}
 
 {\scriptsize\textcolor{red}{Ours}\quad\textcolor{green!50!black}{Ground truth}\quad\textcolor{blue}{U-Net}}\par\vspace{2mm}
 {\small IoU: 47 / 50\% and 29 / 34\% (ours / adapted U-Net).}
\end{column}
\begin{column}{.48\textwidth}
 \textbf{Palais des Papes}
 \vspace{2mm}
 
 \panel{.315}{PalaisDesPapes.png}{Intensity}\hfill
 \panel{.315}{PalaisDesPapes_IntDepth.png}{Depth overlay}\hfill
 \panel{.315}{PalaisDesPapes_Result.png}{Our result}
 \vspace{3mm}
...
\end{column}
\end{columns}
\refnote{\textcopyright\ Cerema. [EUVIP 26]}
\end{frame}
...
\begin{itemize}\setlength\itemsep{3mm}
 ...
 \item $K=2$: connectivity through triangles.
\end{itemize}
\end{column}
...
\end{column}
\end{columns}
\refnote{\textcopyright\ Cerema. [ANS 26; Thesis 26]}
\end{frame}
...
\textbf{Main points}
\begin{itemize}\setlength\itemsep{4mm}
 \item \Frangi{} filter $\rightarrow$ \Frangi{} graph
...
\begin{itemize}\setlength\itemsep{4mm}
 ...
 \item Can a \Frangi{} graph hierarchy help guide SAM / CrackSAM?
\end{itemize}
\end{column}
\end{columns}
\vspace{5mm}
...
\end{tikzpicture}}
\refnote{[EUVIP 26; SAM 23; CrackSAM 24]}
\end{frame}

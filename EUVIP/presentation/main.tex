...
\usepackage{lmodern,amsmath,amssymb,mathtools,array,booktabs,graphicx,qrcode,tikz}
...
\author{Louis Hauseux, Raphaël Antoine, Philippe Foucher, Pierre Charbonnier, Josiane Zerubia}
...
\begin{columns}[T,onlytextwidth]
 ...
 \begin{column}{.43\textwidth}
  \begin{itemize}\setlength\itemsep{5mm}
   ...
   \item Several \textbf{image modalities} may observe the same geometry
...
\begin{frame}[t]{Our contribution: generalized \Frangi{} graph}
\vspace{1mm}
\begin{columns}[c,onlytextwidth]
...
\begin{enumerate}\setlength\itemsep{4mm}
 \item Normalize each modality's Hessian:
 \[
...
\panel{.21}{Resultat_1FIND_red.png}{Skeleton \citb{euvip26}}
\par\vspace{3mm}
...
\begin{tikzpicture}[node distance=3mm,
 ...
 \node[stage,right=of a](b){Extract connected components};
 \node[stage,right=of b](c){Build minimum spanning tree};
...
\begin{column}{.34\textwidth}\centering
 ...
 \panel{.475}{Resultat_1FIND_red.png}{Our result\\\citb{euvip26}}
\end{column}
...
\begin{column}{.57\textwidth}\centering
 ...
 \begin{tikzpicture}
  ...
  \node[anchor=south west,font=\small]at(plot.north west){IoU (\%) \citb{euvip26}};
  \node[anchor=north,font=\small,yshift=-3mm]at(plot.south){Noise standard deviation $s$};
 \end{tikzpicture}
 \par\vspace{1mm}
...
\panel{.46}{ResultatNoisy_1FIND_red.png}{Our result, $s=0.5$}
\par\vspace{.5mm}
\begin{itemize}
...
\begin{column}{.48\textwidth}
 ...
 {\scriptsize\textcolor{red}{Our graph}\quad\textcolor{green!50!black}{Ground truth}\quad\textcolor{blue}{U-Net}}\par\vspace{1mm}
 \begin{itemize}
...
\begin{column}{.48\textwidth}
 ...
 \panel{.315}{PalaisDesPapes_Result_red.png}{Our result\\\textcopyright\ Cerema}
 \vspace{3mm}
...
\begin{minipage}[c]{.20\linewidth}\raggedright
 \href{https://github.com/Ayana-Inria/Frangi-EUVIP}{\textcolor{black}{%
  \qrcode[height=1.25cm,hyperlink=false]{https://github.com/Ayana-Inria/Frangi-EUVIP}}}\par\vspace{.8mm}
 {\scriptsize Code \& data}
\end{minipage}%
% The "Foundation model" box starts at .55\linewidth, the left edge of the
% "Next steps" column. The third box begins .690 of the way along the chain, so
% the chain is .470\linewidth wide and starts at .55-.690*.470 = .2256.
\hspace{.0256\linewidth}%
\begin{minipage}[c]{.7744\linewidth}\raggedright
\resizebox{.607\linewidth}{!}{%
...
\begin{frame}[t,noframenumbering]{Bibliography: higher order and perspective}
\vspace{1mm}
\bibentry{ans26}
\bibentry{sam23}
\bibentry{cracksam24}

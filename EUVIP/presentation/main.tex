...
\begin{columns}[T,onlytextwidth]
 ...
 \begin{column}{.40\textwidth}
  \begin{itemize}\setlength\itemsep{5mm}
   ...
   \item Goal: extract an \textbf{editable crack skeleton} \textbf{without training}. \citb{euvip26}
  \end{itemize}
 \end{column}
\end{columns}
\vspace{2mm}
{\scriptsize FIND \citb{find22}}
...
\begin{tikzpicture}[x=1cm,y=1cm,
 ...
 \end{scope}
\end{tikzpicture}}
\par\vspace{2mm}\citb{gretsi25}\quad\citb{euvip26}
\end{column}
\begin{column}{.40\textwidth}
...
\begin{column}{.44\textwidth}
 ...
 \vspace{2mm}
 {\scriptsize Palais des Papes \citb{euvip26}}
\end{column}
\end{columns}
\reffoot{euvip26}
\end{frame}
...
\]
\vspace{-3mm}
{\small $0<\rho_{ij}=\|x_i-x_j\|_2\le R$.}
\reffoot{euvip26}
\end{frame}
...
Our graph & 63\% & 71\% & 11 px\\
CrackSegDiff & \textbf{87\%} & \textbf{90\%} & \textbf{5 px}\\\bottomrule
\end{tabular}}
\par\vspace{2mm}\citb{euvip26}\quad\citb{cracksegdiff24}
\end{column}
\end{columns}
...
\par\vspace{.5mm}{\scriptsize Shading: standard deviation.}
\end{column}
...
\panel{.42}{IntensityNoisy_1FIND.png}{Noisy intensity}\hfill
\panel{.42}{ResultatNoisy_1FIND.png}{Our result, $s=0.5$}
\vspace{1mm}

{\small Slower degradation under added noise.}
\end{column}
\end{columns}
...
\end{minipage}
\par\vspace{.5mm}{\scriptsize VT-GraF \textcopyright\ Cerema}
\vspace{2mm}

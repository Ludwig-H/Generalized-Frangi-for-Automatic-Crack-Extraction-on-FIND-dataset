...
\begin{alertblock}{Perspective: guiding frozen SAM 2 / CrackSAM with a Frangi hierarchy}
\begin{minipage}[c]{0.485\linewidth}
  \centering\tikzfigure{0.79\linewidth}{foundation-hierarchy}
\end{minipage}\hfill
\begin{minipage}[c]{0.49\linewidth}
  HSA [8] structures attention using an external hierarchy, without retraining
  in its RoBERTa experiments. Apply it to \textbf{frozen SAM 2 [6] / CrackSAM [4]}
  using \textbf{Frangi groups: segments $\to$ branches $\to$ network}.
\end{minipage}
\end{alertblock}
...
Generalizability, and Datasets}, arXiv:2508.10256, 2025.\par
[6] Ravi et al., \emph{SAM 2: Segment Anything in Images and Videos}, arXiv:2408.00714, 2024.\par
[7] Shi et al., \emph{Semi-universal geo-crack detection by machine learning}, Front. Earth Sci. 11, 1073211, 2023.\par
[8] Amizadeh et al., \emph{Hierarchical Self-Attention: Generalizing Neural Attention Mechanics
to Multi-Scale Problems}, NeurIPS, 2025.
\end{minipage}
\par\smallskip

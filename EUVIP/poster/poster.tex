...
\par\vspace{0.25cm}
\panel{0.10}{Intensity_1FIND.png}{Intensity $I$}
...
\hfill\panel{0.10}{GroundTruth_1FIND.png}{Ground truth}
...
\par{\smalltext Contrast and shape reuse classical Frangi cues.
\textbf{The graph adds alignment.}

...
\vspace{1.4cm}
\begin{block}{FIND first example.~{\hypersetup{citecolor=white}\cite{zhou2022find}}}
...
\begin{block}{2. From pixel-wise \textmd{\textsc{Frangi}}~{\hypersetup{citecolor=white}\cite{frangi1998}} to pairwise links}
\centering\tikzfigure{0.86\linewidth}{frangi-terms}\par\RaggedRight
\par{\smalltext \textbf{Classical Frangi terms + neighbor alignment.}

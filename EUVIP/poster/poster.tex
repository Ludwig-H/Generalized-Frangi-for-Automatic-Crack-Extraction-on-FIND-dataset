...
\begin{alertblock}{Perspective: guiding SAM / CrackSAM with a Frangi hierarchy}
\begin{minipage}[c]{0.485\linewidth}
  \centering\tikzfigure{0.79\linewidth}{foundation-hierarchy}
\end{minipage}\hfill
\begin{minipage}[c]{0.49\linewidth}
  Guide attention with \textbf{nested Frangi groups}, from local crack segments
  to the whole network (SAM [6], CrackSAM [4]).
\end{minipage}
\end{alertblock}
...
[6] Kirillov et al., \emph{Segment Anything}, ICCV, 2023.\par
[7] Shi et al., \emph{Semi-universal geo-crack detection by machine learning}, Front. Earth Sci. 11, 1073211, 2023.
\end{minipage}
\par\smallskip

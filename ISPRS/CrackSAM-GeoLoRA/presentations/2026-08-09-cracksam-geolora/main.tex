...
% -----------------------------------------------------------------------------
\begin{frame}{Sa force : hors domaine et sous bruit}
  \centering
  \vspace{0.02cm}
  {\small Entraîné sur Khánh Hà. Testé tel quel sur trois corpus qu'il n'a
  jamais vus.}
  ...
  \begin{tabular}{lrrrrr}
    \toprule
    IoU & test & flou fort & \texttt{Road420} & \texttt{Facade390} &
      \texttt{Concrete3k} \\
    \midrule
    \textbf{CrackSAM} (LoRA \texttt{qv}, $r=4$) & 0,642 & \textbf{0,492} &
      \textbf{0,622} & 0,454 & \textbf{0,680} \\
    SegFormer, le meilleur des 12 autres & \textbf{0,648} & 0,444 & 0,582 &
      \textbf{0,462} & 0,653 \\
    \bottomrule
  \end{tabular}

  \vspace{0.06cm}
  {\fontsize{6.4}{7.4}\selectfont Sur image nette, il est derrière. Dès qu'on
  dégrade ou qu'on change de domaine, il passe devant.}

  \vspace{0.14cm}
  \csrowpanel{0.155}{Image}{1.58cm}{cs_zs_reflet_image}\hfill
  \csrowpanel{0.155}{Vérité terrain}{1.58cm}{cs_zs_reflet_gt}\hfill
  \csrowpanel{0.155}{\textcolor{success}{CrackSAM}}{1.58cm}{cs_zs_reflet_sam}\hfill
  \csrowpanel{0.155}{SegFormer}{1.58cm}{cs_zs_reflet_segformer}\hfill
  \csrowpanel{0.155}{MobileNet}{1.58cm}{cs_zs_reflet_mobilenet}\hfill
  \csrowpanel{0.155}{ResNet-50}{1.58cm}{cs_zs_reflet_resnet}

  \vspace{2pt}
  \csrowpanel{0.155}{}{1.58cm}{cs_zs_ombre_image}\hfill
  \csrowpanel{0.155}{}{1.58cm}{cs_zs_ombre_gt}\hfill
  \csrowpanel{0.155}{}{1.58cm}{cs_zs_ombre_sam}\hfill
  \csrowpanel{0.155}{}{1.58cm}{cs_zs_ombre_segformer}\hfill
  \csrowpanel{0.155}{}{1.58cm}{cs_zs_ombre_mobilenet}\hfill
  \csrowpanel{0.155}{}{1.58cm}{cs_zs_ombre_resnet}

  \vspace{0.14cm}
  \statusbadge{inkblue}{un reflet, puis une ombre portée : c'est cette
  robustesse que la géométrie devait renforcer}

  \source{Tableau 6 du papier. \og Flou fort \fg{} : image réduite de moitié,
  puis floutée. Notre \texttt{baseline} reprend la recette sur SAM 2 Hiera-L.}
\end{frame}

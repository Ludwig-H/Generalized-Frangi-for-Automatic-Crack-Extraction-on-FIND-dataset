...
\begin{frame}{Proposition : CrackSAM Guidé par la Géométrie}
    \begin{block}{Repenser l'Entrée du Modèle (Fusion Précoce)}
        \vspace{3pt}
        \begin{center}
        \begin{tikzpicture}[scale=0.8, every node/.style={transform shape}]
            ...
            \node[draw, fill=orange!5, draw=orange, dashed, minimum width=5.2cm, minimum height=0.5cm, rounded corners=2pt, align=center] (c3) at (0, -0.4) {\scriptsize \textbf{Canal 3} : \textbf{\textit{À définir}} (discussion en réunion)};
    ...
    \begin{block}{Pistes de Réflexion pour la Réunion}
        \begin{itemize}
            \item \textbf{Zéro modification structurelle} : Conserver l'architecture d'origine de \emph{SAM} sans modifier son nombre de canaux d'entrée.
            \item \textbf{Choix du Canal 3} : Quelle information ajouter pour maximiser les performances ? (ex. Thermique/Range brut, carte d'incertitude physique, ou autre information géométrique complémentaire ?).
        \end{itemize}
    \end{block}
\end{frame}

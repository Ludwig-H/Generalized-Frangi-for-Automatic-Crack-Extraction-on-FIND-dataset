            ...
            if len(tri_u) > 0:
                ...
                if valid_tri.any():
                    ...
                    for c_id in v_comp:
                        ...
                        # Branch mass for child branch: subtree
                        M_child_dual = E_m
...
add_md("""## 4bis. Évaluation sur Dataset VT-GraF (Fissures 1, 2, 3)

Tests sur les images du dataset VT-GraF (Fissures 1, 2 et 3) avec les paramètres par défaut du graphe Généralisé.""")
